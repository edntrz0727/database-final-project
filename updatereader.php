	...
	<form action="run_updatepermission.php" method="post">	
	  <table width="500" border="1" bgcolor="#cccccc" align="center">
		...
		<tr>
		 ...
		 <tr>
		  <th>sourcelimit</th>
		  <td bgcolor="#FFFFFF"><input type="text" name="sourcelimit" value="<?php echo $sourcelimit; ?>"/></td>
		</tr>
		<tr>
		  <th>equiplimit</th>
		  <td bgcolor="#FFFFFF"><input type="text" name="equiplimit" value="<?php echo $equiplimit; ?>" /></td>
		</tr>
		<tr>
		  <th colspan="2">
            <div class="move">
