...
<h3 align="center" style="color:brown">修改借閱狀況</h3>
    <?php
        ...
        $mbID=$_GET["id"];
        $sql = "SELECT * FROM m_borrow where mbID = '$mbID'";
        ...
        $state = $row['state'];
    ?>
	<form action="run_updatem_borrow.php" method="post">	
	  <table width="500" border="1" bgcolor="#cccccc" align="center">
		<tr>
			<th>mbID</th>
			<td bgcolor="antiquewhite"><input type="text" name="mbID" value="<?php echo $mbID; ?>" readonly/></td>
		</tr>
		<tr>
		  <th>librarianID</th>
