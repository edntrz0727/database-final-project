...
?>
	...
	<form action="run_updatejournal.php" method="post">	
	  <table width="500" border="1" bgcolor="#cccccc" align="center">
		<tr>
			<th>journalID</th>
			<td bgcolor="#FFFFFF"><input type="text" name="journalID" value="<?php echo $journalID;?>" readonly/></td>
		</tr>
		<tr>
		  <th>title</th>
		...
		<?php   
				...
				if ($result2->num_rows > 0) {	
					while ( $row2 = mysqli_fetch_array ( $result2, MYSQLI_ASSOC ) ) {
                        ...
                        $number = $row2['number'];
						echo "<tr>";
                        echo "<td bgcolor='#FFFFFF'><input type='text' name='id[$count]' value='$libraryjournalID' readonly/></td>";
						echo "<td bgcolor='#FFFFFF'><input type='text' name='mediaIDplace[$count]' value='$journalID' readonly/></td>";
